...
export function AnimatedLogo({ className, imageClassName }: AnimatedLogoProps) {
  ...
  const handlePointerEnter = () => {
    if (canHover) setTextHovered(true);
  };
